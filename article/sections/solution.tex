...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.7\textwidth, keepaspectratio]{figures/smart_places_solution_overview}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=1\textwidth, keepaspectratio]{figures/screenshots/ownersapp}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=1\textwidth, keepaspectratio]{figures/screenshots/ownersapp_configure}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.7\textwidth, keepaspectratio]{figures/screenshots/clientapp_entry}
...
\subsubsection{Smart Restaurant}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.8\textwidth, keepaspectratio]{figures/screenshots/smart_restaurant_app}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.4\textwidth, keepaspectratio]{figures/screenshots/smart_museum_app}
