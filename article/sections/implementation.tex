...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.5\textwidth, keepaspectratio]{figures/estimote}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.5\textwidth]{figures/backend_data_model}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.5\textwidth, height=0.15\textheight,
      keepaspectratio]{figures/smartplaces_package}
...
\subsubsection{Mobile App for Owners}
...
\subsubsection{Mobile App for End Users}
