...
\subsubsection{\glstext{GPS}}
\label{sub:background_gps}
% What is it
% How it works
\glsfirst{GPS} is a location system that uses 24 sattelites plus three backups.
...
% What is it
% How it works
\glsfirst{QR} codes is a type of two dimensional barcode.
...
\subsubsection{Proximity-based Apps}
...
% -> Context-awareness
% -> Dynamix
In order to get a good insight the potential of proximity-based services, we analyzed two applications.
