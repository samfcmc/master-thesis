...
Dois exemplos de \textit{Smart Places} foram desenvolvidos, o \textit{Smart Restaurant} e \textit{Smart Museum}.
...
Foi avaliado o consumo energético desta aplicação e os resultados demonstram que a descarga de bateria pode ser aceitável, numa utilização diária com recurso ao WiFi como meio de ligação de dados.
No entanto, utilizando 3G foi verificado que a bateria descarrega mais de 200 vezes mais rápido.
