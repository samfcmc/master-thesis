...
Um \textit{Smart Place} é um lugar fisico onde \textit{tags} são colocadas para fornecer um serviço baseado em proximidade.
...
Nesta dissertação, utilizámos \textit{beacons bluetooth low energy} com o protocolo \textit{ibeacon} para colocar etiquetas nos pontos de interesse.
