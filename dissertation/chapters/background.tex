...
The necessary infrastructure is the major cost here.
...
% QR
\gls{QR} Codes could be used in our solution.
However, it requires the users to be aware of such codes and start the scanning process themselves instead of being an automatic process happening in background.

% NFC
\gls{NFC} is based on proximity and it can provide symbolic location, which are the foundations of Smart Places.
...
It provides physical location. As any physical location system, it can be augmented to provide symbolic location.
However, the buildings need to be first mapped by Google.
