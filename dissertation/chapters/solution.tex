...
\begin{itemize}
  ...
  The app only allows log in using user's Facebook account, because it was easy to integrate in our solution.
...
% -> Context-awareness
% -> Dynamix
In order to get a good insight the potential of proximity-based services, we analyzed three applications.
